...
static_house_data <- read.csv("C:/Users/divya/Downloads/IDSFinalProject/static_house_data.csv")
```

```{r}
# Read the weather data from the 'weather_data.csv' file
weather_data <-read.csv("C:/Users/divya/Downloads/IDSFinalProject/weather_data.csv")
```

```{r}
# Read the energy usage data from the 'energy_usage_data.csv' file
energy_usage_data <- read.csv("C:/Users/divya/Downloads/IDSFinalProject/energy_usage_data.csv")
```
...
```{r}
write_csv(energy_static_weather_data, "C:/Users/divya/Downloads/IDSFinalProject/energy_static_weather_data.csv")
```
